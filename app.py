...
def portal_tab(tab_id):
    ...
    return render_template("portal.jinja2", tabs=tabs, types=types ,organizations=organizations, count_organizations=count_organizations, tab_selected=tab_id, is_start_up=is_start_up)
